...
// Construtores
    ...
    public Reserva(Integer numeroQuarto, Date chekIn, Date checkOut) throws DominioExcecoes {
        if (!checkOut.after(checkIn)) {
            throw new DominioExcecoes("a data de check-out deve ser posterior à data de check-in");
        }
...
// Tiramos o void, pois o método tem que retornar uma String. 
    ...
    public void dadasAtualizadas(Date chekIn, Date chekOut) throws DominioExcecoes {
...
// Não preciso retornar nada e sim lançar uma exceção. Criamos uma exceção na classe DominioExececoes. 
            throw new DominioExcecoes("As datas de reserva para atualizações devem ser datas futuras");
        }
        if (!checkOut.after(checkIn)) {
            throw new DominioExcecoes("a data de check-out deve ser posterior à data de check-in");
        }
